...
from preflibtools.properties.subdomains.ordinal.singlepeaked.k_alternative_partition import (
...
class TestKAlternativesPartition(TestCase):
    def test_alt_partition_single_peaked(self):
        # test 1, sp profile
        params = {"num_voters": 400, "partitions": [11], "seed": 2}
        ...
        params = {"num_voters": 400, "partitions": [6, 3, 2, 4, 1], "seed": 2}
        vote_map = prefsampling_ordinal_wrapper(generate_k_alt_partition_sp, params)
        instance = OrdinalInstance()
        instance.append_vote_map(vote_map)
        ...
        params = {"num_voters": 400, "partitions": [7, 2, 2, 2, 5, 2, 1], "seed": 5}
        vote_map = prefsampling_ordinal_wrapper(generate_k_alt_partition_sp, params)
        instance = OrdinalInstance()
        instance.append_vote_map(vote_map)
