...
from preflibtools.properties.subdomains.ordinal.single_peaked.k_alternative_partition import k_alt_partition_approx, k_alternative_partition_brut_force
